...
countries <- c("PNG", "IDN", "FSM", "PHL", "MYS", "VNM", "KHM", "LKA", "BRA", "BOL", "ECU", "PER", "GUF", "SUR", "GUY", "VEN", 
               "COL", "PAN", "CRI", "NIC", "TTO", "BRB", "GRD", "SYC") #MDV
countries <- c("BRA", "BOL", "ECU", "PER", "GUF", "SUR", "GUY", "VEN", "COL", "PAN", "CRI", "NIC", "TTO", "BRB", "GRD", "SYC")
...
for(i in 1:length(countries)){
  ...
  for(j in 1:length(crops)){
    ...
    #x <- paste0("C:/Users/syedm/Desktop/soil/spam2010v2r0_global_harv_area.geotiff/spam2010V2r0_global_H_", crops[j], "_A.tif")
    
    #physical area
    #x <- paste0("C:/Users/syedm/Desktop/soil/spam2017v2r1_ssa_phys_area.geotiff/spam2017V2r1_SSA_A_", crops[j], "_A.tif")
    #x <- paste0("C:/Users/syedm/Desktop/soil/spam2010v2r0_global_phys_area.geotiff/spam2010V2r0_global_A_", crops[j], "_A.tif")
    
    #yield
    #x <- paste0("C:/Users/syedm/Desktop/soil/spam2017v2r1_ssa_yield.geotiff/spam2017V2r1_SSA_Y_", crops[j], "_A.tif")
    #x <- paste0("C:/Users/syedm/Desktop/soil/spam2010v2r0_global_yield.geotiff/spam2010V2r0_global_Y_", crops[j], "_A.tif")
    
    #value of production
    #x <- paste0("C:/Users/syedm/Desktop/soil/spam2017v2r1_ssa_val_prod.geotiff/spam2017V2r1_SSA_V_", crops[j], "_A.tif")
    #x <- paste0("C:/Users/syedm/Desktop/soil/spam2010v2r0_global_val_prod_agg.geotiff/spam2010V2r0_global_V_", crops[j], "_A.tif")
    
    #production
    #x <- paste0("C:/Users/syedm/Desktop/soil/spam2017v2r1_ssa_prod.geotiff/spam2017V2r1_SSA_P_", crops[j], "_A.tif")
    #x <- paste0("C:/Users/syedm/Desktop/soil/spam2010v2r0_global_prod.geotiff/spam2010V2r0_global_P_", crops[j], "_A.tif")
...
df <- cbind(df_soil, df_air, df_bio, df_crop, df_elevate, df_fertilizer, df_ho, df_pop, df_area, df_imr)
...
df1 <- read.csv("df_areaprop_total.csv")
df1 <- df1[complete.cases(df1), ]
...
mod1 <- multinom(c ~ V3+V4+V5+V6+V7+V8+V9+V10+V11+V12+V13+V14+V15+V16+V17+V18+V19+V20+V21+V22+V23+V24+V25+V26+V27+V28+V29+V30+
             bio1+bio2+bio3+bio4+bio5+bio6+bio7+bio8+bio9+bio10+bio11+bio12+bio13+bio14+bio15+bio16+bio17+bio18+bio19+
             pm2_5 + elevation	+ nfert	+ pfert	+ nman + pman	+ hydro	+ oxy	+ pop + area + prop_area + as.factor(V1) + as.factor(Region), 
             MaxNWts =10000000, maxit=100, data=df1)
summary(mod1)
...
df1$actual <- df2$col
df1$pred <- df2$col
df1$y <- ifelse(df1$actual==df1$pred, 1, 0)
...
mod1 <- lm(imr ~ y + V3+V4+V5+V6+V7+V8+V9+V10+V11+V12+V13+V14+V15+V16+V17+V18+V19+V20+V21+V22+V23+V24+V25+V26+V27+V28+V29+V30+
             bio1+bio2+bio3+bio4+bio5+bio6+bio7+bio8+bio9+bio10+bio11+bio12+bio13+bio14+bio15+bio16+bio17+bio18+bio19+
             pm2_5 + elevation	+ nfert	+ pfert	+ nman + pman	+ hydro	+ oxy	+ pop + area + prop_area + as.factor(V1) + as.factor(Region), data=data)
summary(mod1)
data.frame(summary(mod1)$coef[summary(mod1)$coef[,4] <= 0.10, 1])
